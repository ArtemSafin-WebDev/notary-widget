document.addEventListener("DOMContentLoaded", function() {
    function widgetController(element) {
        ...
        function _addValidators() {
            ...
            Parsley.addMessages("ru", {
                ...
                minlength:
                    "Это значение должно содержать не менее %s символов.",
                maxlength:
    ...
    var widgetElement = document.querySelector(".js-application-widget");

    if (widgetElement) {
        window.appWidget = widgetController(widgetElement);
        appWidget.init();
    }
});
